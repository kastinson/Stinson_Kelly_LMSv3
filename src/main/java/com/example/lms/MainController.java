...
public class MainController {
    ...
    private void addBook() {
        try {
            ...
            controller.setBookDatabase(bookService);
    ...
    private void removeBook() {
        ...
        dialog.showAndWait().ifPresent(input -> {
            ...
            boolean success = bookService.removeBook(input);
    ...
    private void checkOutBook() {
        ...
        dialog.showAndWait().ifPresent(input -> {
            ...
            boolean success = bookService.checkOutBook(input);
    ...
    private void checkInBook() {
        ...
        dialog.showAndWait().ifPresent(input -> {
            ...
            boolean success = bookService.checkInBook(input);
     ...
     * This method loads the BookTableView.fxml file and sets up the ViewBooksController
    ...
    private void loadBooksFromFile() {
        ...
        if (file != null) {
            ...
            try {
                ...
                bookService.loadBooksFromFile(filePath);
